 ...
 * `returnValue`. This shim reproduces exactly the surface
 * `@asnewyla/unstyled-dialog` wires against — duplicated here (not shared)
 * since it's test-only infrastructure, same as every other small
 * cheap-to-duplicate primitive concern in this repo.
 *
